...
use App\Filament\Fodig\Resources\SiebelViewResource\Pages;
use App\Filament\Fodig\Resources\SiebelViewResource\RelationManagers;
...
class SiebelViewResource extends Resource
{
    protected static ?string $model = SiebelView::class;
    ...
    {
        return [
            'index' => Pages\ListSiebelViews::route('/'),
            'create' => Pages\CreateSiebelView::route('/create'),
            'view' => Pages\ViewSiebelView::route('/{record}'),
            'edit' => Pages\EditSiebelView::route('/{record}/edit'),
        ];
    }
}
