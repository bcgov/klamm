...
class ChildColumnsRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Child Columns (Foreign Key Dependents)';
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Placeholder::make('child_column_info')
                    ->label('Child Column Details')
                    ->content(function (?AnonymousSiebelColumn $record): string {
                        if (! $record) {
                            return 'Select a child column to view details.';
                        }
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->heading('Child Columns (Foreign Key Dependents)')
            ->description('Columns that reference this column via foreign keys.')
            ->columns([
