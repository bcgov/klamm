...
class ReferencesRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'References Fields';

    protected static ?string $description = 'These are Siebel Fields that this field references in its calculated value';
    ...
    {
        return $table
            ->heading('Calculated Value: Fields Used')
            ->columns([
