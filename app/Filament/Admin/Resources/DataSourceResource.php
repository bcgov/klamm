...
use App\Filament\Admin\Resources\DataSourceResource\Pages;
use App\Filament\Admin\Resources\DataSourceResource\RelationManagers;
...
class DataSourceResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewDataSource::route('/{record}'),
