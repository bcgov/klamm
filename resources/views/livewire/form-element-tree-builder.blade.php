<div>
    @if($formVersionId)
    <x-filament-tree::tree
        :model="$this->getModel()"
        :maxDepth="$this->getMaxDepth()"
        :treeTitle="$this->treeTitle"
        :enableTreeTitle="$this->enableTreeTitle"
        :records="$this->getTreeQuery()->get()"
        :treeActions="$this->getTreeActions()"
        :formSchema="$this->getFormSchema()"
        :viewFormSchema="$this->getViewFormSchema()" />
    @else
