    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="{{ url('/reports') }}" class="block p-6 bg-white dark:bg-gray-800 border rounded-lg shadow hover:bg-gray-100 dark:hover:bg-gray-700">
            <div class="flex items-center space-x-2">
                <img src="{{ asset('svg/report-dictionary-logo-text-light.svg') }}" alt="Report Dictionary Logo" class="block dark:hidden">
                <img src="{{ asset('svg/report-dictionary-logo-text-dark.svg') }}" alt="Report Dictionary Logo" class="hidden dark:flex">
            </div>
